...
<div class="wrap">
	...
	<h2><?php _e( 'WP Team Showcase and Slider with ', 'wp-team-showcase-and-slider' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'wp-team-showcase-and-slider' ); ?></h2><br />	
		...
		<div id="post-body" class="metabox-holder columns-2">
					 ...
					 <thead>
						<tr>
							...
							<th>
								...
								<p>Gain access to <strong>WP Team Showcase and Slider</strong> included in <br /><strong class="wpos-epb">Essential Plugin Bundle</strong></p>
								<a href="<?php echo WP_TSAS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Team-Showcase&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
							</th>
						</tr>
					</thead>
					<tbody>
			...
			<div id="postbox-container-1" class="postbox-container wpos-sidebar">
				<div class="wpos-epb-wrap">
					...
					<ul>
						<li><b>40+ Utility Plugins</b> including <span><?php echo WP_TSAS_NAME; ?> premium </span> version.</li>
					...
					<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo WP_TSAS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
				</div>
